const products = [
    ...
    },
    {
        ...
        thumbnail: "https://cdn.dummyjson.com/product-images/30/thumbnail.jpg",
                    ...
                    function  newGoToFunction (products){
                        const container = document.getElementById('product-countainer');
                        ...
                        <div class="product-box"> 
                            ...
                            <div class="fa fa-shopping-cart" onclick="addToCart(${product.id})"></div> 
                        </div>     
                        </div>
                        </div>
                    ...
                    function addToCart(qwerty){
                        console.log(qwerty)
                    }

                    newGoToFunction(products)
